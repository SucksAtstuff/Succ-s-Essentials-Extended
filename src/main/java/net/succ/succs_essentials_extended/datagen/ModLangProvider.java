...
import net.succ.succs_essentials_extended.enchant.ModEnchants;
...
public class ModLangProvider extends LanguageProvider {
    ...
    public ModLangProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookup) {
        super(output, Succs_essentials_extended.MOD_ID, "en_us");
        this.lookup = lookup;
    }
    ...
    protected void addTranslations() {
        ...
        BIOME_KEYS.forEach(key ->
                add("biome." + Succs_essentials_extended.MOD_ID + "." + key.location().getPath(),
        ...
        ENCHANT_KEYS.forEach(key ->
                add("enchantment." + Succs_essentials_extended.MOD_ID + "." + key.location().getPath(),
                        format(key.location().getPath()))
        );
        ...
        ModCreativeModeTabs.CREATIVE_MODE_TAB.getEntries().forEach(entry -> {
            ...
            String key = "creativetab." + Succs_essentials_extended.MOD_ID + "." + clean + ".tab";
