package net.succ.succs_essentials_extended;
...
@Mod(Succs_essentials_extended.MOD_ID)
public class Succs_essentials_extended {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "succs_essentials_extended";
